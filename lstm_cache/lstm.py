...
# Play with learning rate
    ...
    def train(self, data, labels):
        ...
        data = np.ravel(data).reshape((self.NUM_CONTENT_TYPES * self.MINIBATCH_SIZE, self.timesteps, self.features))
        labels = np.ravel(labels).reshape((self.NUM_CONTENT_TYPES*self.MINIBATCH_SIZE, 1, 1))
        ...
        model.fit(data, labels, verbose=2)
